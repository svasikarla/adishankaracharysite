            ...
            <Section className="bg-background pt-24 pb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {CONCEPTS.map((concept) => (
                        <Link key={concept.id} href={`/philosophy/${concept.slug}`} className="block h-full">
                            <Card className="group hover:border-primary/50 transition-all duration-300 border-primary/10 bg-card/50 backdrop-blur-sm h-full">
                                <CardHeader>
